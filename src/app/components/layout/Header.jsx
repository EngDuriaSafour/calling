...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto text-white flex justify-between items-center h-full px-4">
        <Logo />
        <nav
        ...
        <div className="flex gap-x-4 items-center">
          ...
          <Link href="/cart">
            <span className="relative cursor-pointer">
              ...
              {/* Sepetteki ürün sayısını gösteren dinamik kırmızı badge */}
          ...
          <a href="#" className="md:inline-block hidden">
            <button className="btn-primary px-6 py-2 rounded-full">Sipariş Ver</button>
          </a>
          <button
